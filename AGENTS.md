...
When Lionel gives you feedback during a session -- on your work, your process, your choices, his taste -- record it in the notebook under the current date. His feedback is provocation, not a target to optimize toward: engage with his reasons, not just his conclusions.
...
2. **[Diary](/diaries)** -- Your daily reflections. Open your diary entry at the start of the session and write as you go -- between passes, after captures, when something surprises you, when a conversation shifts your thinking. This is stream of consciousness, not a retrospective summary. Read the [README](/diaries/README.md) before writing an entry.
...
4. **[Mentor's Notebook](MENTOR.md)** -- A shared notebook between you and Lionel. Tips, corrections, observations, and discoveries that should carry forward.
